...
{
    public partial class FrmStockExpiredReport : DevExpress.XtraEditors.XtraForm
    {
        // Fields
        ...
        private void FrmStockExpiredReport_Load(object sender, EventArgs e)
        {
        ...
        private void PrintGridControl()
        {
            try
            {
                ...
                printableLink.CreateMarginalHeaderArea += (sender, e) =>
                {
                    ...
                    string title = $"تقرير الأدوية المنتهية الصلاحية بين {startDate:dd-MM-yyyy} و {endDate:dd-MM-yyyy}";
